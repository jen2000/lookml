view: qppar__prod__20170721t041436__extract_outpatient_claims__outpatient_claims {
  sql_table_name: default.qppar__prod__20170721t041436__extract_outpatient_claims__outpatient_claims ;;
  suggestions: no
  ...
  dimension: nch_bene_ptb_coinsrnc_amt {
    type: string
    sql: ${TABLE}.nch_bene_ptb_coinsrnc_amt ;;
  }

  dimension: nch_bene_ptb_ddctbl_amt {
    type: string
    sql: ${TABLE}.nch_bene_ptb_ddctbl_amt ;;
  }
