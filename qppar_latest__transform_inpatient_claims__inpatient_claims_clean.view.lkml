view: qppar_latest__transform_inpatient_claims__inpatient_claims_clean {
  sql_table_name: default.qppar_latest__transform_inpatient_claims__inpatient_claims_clean ;;
  suggestions: no
